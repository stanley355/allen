...
pre_event_count_per_user = np.array([1.5,	1,	1,	2.5,	1.2, 3,	1,	5,	1,	4.5, 7.5,	11,	1,	4,	4.3])
...
post_event_count_per_user = np.array([1.5,	1,	1,	2.5,	1.2, 4,	4.3,	3.17,	7.3,	2.5, 2.3,	13,	1,	8	,15])
